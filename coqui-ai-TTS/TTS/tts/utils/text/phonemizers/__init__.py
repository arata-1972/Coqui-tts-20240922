...
from TTS.tts.utils.text.phonemizers.nan_tw_phonemizer import NAN_TW_Phonemizer
...
DEF_LANG_TO_PHONEMIZER["nan-tw"] = NAN_TW_Phonemizer.name()
#DEF_LANG_TO_PHONEMIZER["nan-tw"] = ESpeak.name()
...
def get_phonemizer_by_name(name: str, **kwargs) -> BasePhonemizer:
    ...
    if name == "nan_tw_phonemizer":
        return NAN_TW_Phonemizer(**kwargs)
        #return ESpeak(**kwargs)
...
if __name__ == "__main__":
    print('naniiiiiiiiiii=', DEF_LANG_TO_PHONEMIZER)